...
/* Private defines -----------------------------------------------------------*/
#define EWG_Pin GPIO_PIN_1
#define EWG_GPIO_Port GPIOA
#define EWR_Pin GPIO_PIN_2
#define EWR_GPIO_Port GPIOA
#define EWY_Pin GPIO_PIN_3
#define EWY_GPIO_Port GPIOA
#define SNG_Pin GPIO_PIN_4
#define SNG_GPIO_Port GPIOA
#define SNR_Pin GPIO_PIN_5
#define SNR_GPIO_Port GPIOA
#define SNY_Pin GPIO_PIN_6
