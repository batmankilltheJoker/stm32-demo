...
uint8_t FlowWaterLEDsCtrl(uint8_t LED_Index,uint16_t n_delay_ms);
uint8_t WalkHouseLEDsCtrl(uint8_t LED_Index,uint16_t n_delay_ms);

uint8_t LEDCtrl(uint8_t CtrolCode); //Ctrol//
